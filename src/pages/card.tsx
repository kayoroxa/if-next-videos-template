      ...
      {data.map((_, index) => (
        ...
        >
          <div className="relative w-full preserve-3d group-hover:rotate-y-180 h-full duration-1000 flex ">
            <figure className="preserve-3d perspective p-5 text-center absolute backface-hidden border-4 rounded-xl w-full h-full flex flex-col gap-6 items-center justify-center bg-cyan-600 ">
              <section className="h-[49%] bg-white rounded-3xl overflow-hidden translate-z-5 shadow-2xl">
                <video
              ...
              <div className="text-6xl translate-z-2">
                {data[index][0].split('=')[0]}
              </div>
            </figure>
            <figure className="preserve-3d perspective p-5 text-center absolute backface-hidden border-4 rounded-xl w-full h-full flex flex-col gap-6 items-center justify-center rotate-y-180 bg-red-600">
              <div className="text-6xl translate-z-5">
                {data[index][0].split('=')[1]}
              </div>
            </figure>
          </div>
        </motion.div>
